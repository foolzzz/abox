...
type Store interface {
	...
	GetHost(ctx context.Context, organizationID, id string) (domain.Host, error)
	...
	GetWorkspace(ctx context.Context, organizationID, id string) (domain.Workspace, error)
	...
	CreateHostCommand(ctx context.Context, command domain.HostCommand) (domain.HostCommand, error)
